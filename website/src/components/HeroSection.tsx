...
export const HeroSection = () => {
  return <section className="relative min-h-[90vh] flex items-center pt-24">
      ...
      {/* Quick Links Panel - Positioned at top right */}
      <div className="absolute top-36 right-4 md:right-8 lg:right-12 z-20 animate-scale-in">
        <div className="bg-card/95 backdrop-blur-md rounded-2xl p-4 md:p-5 shadow-2xl w-[280px] md:w-[320px]">
